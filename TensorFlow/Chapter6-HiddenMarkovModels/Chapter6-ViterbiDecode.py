''' In contrast to the forward algorithm, shown in the previous script, the Viterbi
decoding algorithm finds the most likely sequence of hidden states given a sequence
of observations.
'''
...
class HMM(object):
    def __init__(self, initial_prob, trans_prob, obs_prob):
        ...
        self.viterbi = tf.placeholder(tf.float64) # Similar to the cache in the forward algorithm
